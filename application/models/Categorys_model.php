...
class Categorys_model extends CI_Model {
    ...
    /**
     * Get list of non-deleted categorys
     *
     * @param  int $limit
     * @param  int $offset
     * @param  array $filters
     ...
     */
    function get_all($limit = 0, $offset = 0, $filters = array(), $sort = 'category_id', $dir = 'ASC')
    {
        $sql = "
		 ...
		 { 
		   ...
		   $sql = "
            ...
            $sql .= "					
					...
					WHERE category_id = " . $this->db->escape($data['id']) . "
                    AND deleted = '0'
            ";
