...
class User extends Login_Controller {
    ...
    { 
        ...
        // load views
        $data['content'] = $this->load->view('admin/user/login', $data, TRUE);
    ...
    function register()
    {
        ...
        if ($this->form_validation->run() == TRUE)
        {
            ...
            if ($validation_code)
            {
                ...
                $validation_url  = base_url('admin/user/validate') . "?e={$encrypted_email}&c={$validation_code}";
        ...
        // load views
        $data['content'] = $this->load->view('admin/user/profile_form', $content_data, TRUE);
        $this->load->view($this->template, $data);
    }
	...
	function forgot()
	{
        ...
        // load views
        $data['content'] = $this->load->view('admin/user/forgot_form', $content_data, TRUE);
        $this->load->view($this->template, $data);
    }
