...
<div class="panel panel-default">
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-12 text-right">
                <a class="btn btn-success btn-sm tooltips" href="<?php echo base_url('admin/subcategorys/add'); ?>" title="<?php echo lang('subcategorys tooltip add_new_user') ?>" data-toggle="tooltip"><span class="glyphicon glyphicon-plus-sign"></span> <?php echo lang('subcategorys button add_new_user'); ?></a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped table-hover-warning pad5">
        <thead> 
            <tr>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=subcategory_id&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('subcategorys col subcategory_id'); ?></a>
                    <?php if ($sort == 'subcategory_id') : ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td>
				
				 <td>
                    <a href="<?php echo current_url(); ?>?sort=category_id&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('subcategorys input subcategory name'); ?></a>
                    <?php if ($sort == 'category_id') : ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td>
				
                <td>
                    <a href="<?php echo current_url(); ?>?sort=name&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('subcategorys col name'); ?></a>
                    <?php if ($sort == 'name') : ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif; ?>
                </td> 
				
                <td>
                    <a href="<?php echo current_url(); ?>?sort=status&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('subcategorys col status'); ?></a>
			 ...
			 <td>
                    <a href="<?php echo current_url(); ?>?sort=created&dir=<?php echo (($dir == 'asc' ) ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('subcategorys input company date created'); ?></a>
            ...
            <tr>
                <?php echo form_open("{$this_url}?sort={$sort}&dir={$dir}&limit={$limit}&offset=0{$filter}", array('role'=>'form', 'id'=>"filters")); ?>
                    ...
                    <th<?php echo ((isset($filters['name'])) ? ' class="has-success"' : ''); ?>>
                        <?php echo form_input(array('name'=>'name', 'id'=>'name', 'class'=>'form-control input-sm', 'placeholder'=>lang('subcategorys input first name'), 'value'=>set_value('name', ((isset($filters['name'])) ? $filters['name'] : '')))); ?>
                    </th>
                 ...
                 <th<?php echo ((isset($filters['status'])) ? ' class="has-success"' : ''); ?>>
					...
					<th<?php echo ((isset($filters['created'])) ? ' class="has-success"' : ''); ?>>
                        <div class="input-group date" data-date="<?php echo date('m-d-Y'); ?>" data-date-format="mm-dd-yyyy">
                            <?php echo form_input(array('name'=>'created', 'id'=>'created', 'class'=>'form-control input-sm', 'readonly'=>'readonly', 'placeholder'=>lang('subcategorys input company date created'), 'value'=>set_value('created', ((isset($filters['created'])) ? $filters['created'] : '')))); ?>
        ...
        <tbody>
            ...
            <?php if ($total) : ?>
                <?php foreach ($subcategorys as $category) : ?>
                    <tr>
                        <td<?php echo (($sort == 'subcategory_id') ? ' class="sorted"' : ''); ?>>
                            <?php echo $category['subcategory_id']; ?>
                        </td>
...
<td<?php echo (($sort == 'created') ? ' class="sorted"' : ''); ?>>
                        ...
                        <td>
                            <div class="text-right">
                                <div class="btn-group">
                                    <a href="#modal-<?php echo $category['subcategory_id']; ?>" data-toggle="modal" class="btn btn-danger btn-sm" title="<?php echo lang('admin button delete'); ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                    <a href="<?php echo $this_url; ?>/edit/<?php echo $category['subcategory_id']; ?>" class="btn btn-warning btn-sm" title="<?php echo lang('admin button edit'); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                </div>
                            </div>
                        </td>
                    </tr>
...
<?php if ($total) : ?>
    <?php foreach ($subcategorys as $category) : ?>
        <div class="modal fade" id="modal-<?php echo $category['subcategory_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-label-<?php echo $category['subcategory_id']; ?>" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 id="modal-label-<?php echo $category['subcategory_id']; ?>"><?php echo lang('subcategorys title client_delete');  ?></h4>
                    </div>
                    <div class="modal-body">
                        <p><?php echo sprintf(lang('subcategorys msg delete_confirm'), $category['name']); ?></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo lang('core button cancel'); ?></button>
						<a href="<?php echo $this_url; ?>/delete/<?php echo $category['subcategory_id']; ?>" class="btn btn-danger" title="<?php echo lang('admin button delete'); ?>"><?php echo lang('admin button delete'); ?></a>
