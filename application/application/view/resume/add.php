                            ...
                            <div class="col-md-6">
                                <div class="box box-info">
                                    <div class="box-body">
										...
										<div class="form-group">
                                            <label for="first_name" class="col-sm-2 control-label">First Name<strong>*</strong> </label>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" readonly  class="form-control startYear" id="date_of_birth" name="date_of_birth" placeholder="Date of birth (mm/dd/yyyy)" value="<?php echo (isset($candidate->date_of_birth)) ? htmlspecialchars($candidate->date_of_birth, ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input readonly type="text" class="form-control startMonth" id="if_selected_when_join" name="if_selected_when_join" placeholder="If selected, when can you join" value="<?php echo (isset($candidate->if_selected_when_join)) ? htmlspecialchars($candidate->if_selected_when_join, ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <input type="number" max="<?php echo date('Y'); ?>" min="<?php echo (date('Y')-100); ?>" title="Year: 2017" class="form-control" id="graduation_year_2" name="graduation_year[]" placeholder="Graduation Year (yyyy)" value="<?php echo (isset($finalCandidateEducational[1]['graduation_year'])) ? htmlspecialchars($finalCandidateEducational[1]['graduation_year'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <input type="number" max="<?php echo date('Y'); ?>" min="<?php echo (date('Y')-100); ?>"  title="Year: 2017" class="form-control" id="graduation_year_3" name="graduation_year[]" placeholder="Graduation Year (yyyy)" value="<?php echo (isset($finalCandidateEducational[2]['graduation_year'])) ? htmlspecialchars($finalCandidateEducational[2]['graduation_year'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="reference_name_1" name="ref_name[]" placeholder="Name" value="<?php echo (isset($finalPreviousEmployment[0]['ref_name'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_name'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="state" class="col-sm-2 control-label">Designation</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="reference_designation_1" name="ref_designation[]" placeholder="Designation" value="<?php echo (isset($finalPreviousEmployment[0]['ref_designation'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_designation'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control" id="reference_email_1" name="ref_email[]" placeholder="Email" value="<?php echo (isset($finalPreviousEmployment[0]['ref_email'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_email'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" pattern="[0-9]{10}" title="Phone: 555-555-5555" class="form-control" id="reference_phone_number_1" name="ref_phone[]" placeholder="Phone: 555-555-5555" value="<?php echo (isset($finalPreviousEmployment[0]['ref_phone'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_phone'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div> 
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="city" class="col-sm-2 control-label">Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="reference_name_2" name="ref_name[]" placeholder="Name" value="<?php echo (isset($finalPreviousEmployment[0]['ref_name'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_name'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="state" class="col-sm-2 control-label">Designation</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="reference_designation_2" name="ref_designation[]" placeholder="Designation" value="<?php echo (isset($finalPreviousEmployment[0]['ref_designation'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_designation'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="email" class="col-sm-2 control-label">Email</label>
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control" id="reference_email_2" name="ref_email[]" placeholder="Email" value="<?php echo (isset($finalPreviousEmployment[0]['ref_email'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_email'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="email" class="col-sm-2 control-label">Phone</label>
                                            <div class="col-sm-10">
                                                <input type="text" pattern="[0-9]{10}" title="Phone: 555-555-5555" class="form-control" id="reference_phone_number_2" name="ref_phone[]" placeholder="Phone: 555-555-5555" value="<?php echo (isset($finalPreviousEmployment[0]['ref_phone'])) ? htmlspecialchars($finalPreviousEmployment[0]['ref_phone'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                            </div>
                                        </div>
                                ...
                                <div class="">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea id="best_fit" class="form-control" name="best_fit" placeholder="Why do you think you are the best fit for this position?"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea id="intersting_about_you" name="intersting_about_you" class="form-control" placeholder="What is interesting about you?"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 document">
                                ...
                                <div class="form-group documentDiv-1">
                                    <label for="document-title-1" class="col-sm-2 control-label">Document </label>
                                    <div class="col-xs-4">
    ...
    <script>
        $(document).ready(function() {
							...
							$.ajax({
								...
								success: function(data) {
									if (data.status == "sucess") {
										setTimeout(function(){ window.location.href = "<?php echo URL; ?>/resume/success"; },500);						 
										//$("#candidate_id").val(data.insetedId);
										//$(".clsSucess").show();
										//$(".clsError").hide();
										/*$('html, body').animate({
											scrollTop: $(".clsSucess").offset().top
										}, 2000);*/
            ...
            $(".addMore").click(function() {
                ...
                appString += '<div class="col-xs-4"><input pattern="[A-Za-z]{3,30}" required title="3 to 30 characters only"';
