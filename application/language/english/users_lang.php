...
$lang['users input is_active']                   = "Status";
$lang['users input username']                 = "Username";
$lang['users input username_email']           = "Username or Email";
$lang['users input access_level']          = "Access Level";

$lang['users input phone no work']          = "Phone no work";
$lang['users input phone no']          = "Phone no";
$lang['users input mobile_no']          = "Mobile No";
$lang['users input activation_code']          = "Activation code";
$lang['users input registration_date']          = "Registration date";
$lang['users input client_id']          = "Client Name";
$lang['users input note']          = "Note";
$lang['users input user_type_id']          = "User type";
